...
draft: true
template: page
path: /example-content-only-page
components:
  - type: Text
    text: >-
      ...
      **Bold text** next to *italic text* and an example of <u>underlined text</u> & <mark>highlighting</mark> via html tag.
      ...
      <img src="https://picsum.photos/100/100" alt="" width="100" height="100" />
      ...
      **Center alignment snippet:**
      ...
      <img src="https://picsum.photos/1400/500" alt="" width="100%" height="500" />
